...
namespace DataSpreads.Security.Crypto.Ethereum
{
    // TODO review if that nasty 65th byte could be dropped from payload, Zeppelin has non-malleable verify that expects fixed s param.

    [DebuggerDisplay("{" + nameof(ToString) + "()}")]
    [StructLayout(LayoutKind.Sequential, Size = Size)]
    [BinarySerialization(Size)]
    public unsafe struct EthSignature65 : IEquatable<EthSignature65>
    {
        ...
        ///
        /// </summary>
        public EthSignature65(string base64)
        {
            ...
            Unsafe.AsRef(in this) = Unsafe.As<byte, EthSignature65>(ref bytes[0]);
        }
        ...
        public EthSignature65(ReadOnlySpan<byte> bytes)
        {
            ...
            Unsafe.AsRef(in this) = Unsafe.As<byte, EthSignature65>(ref Unsafe.AsRef(in bytes[0]));
        }

        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(EthSignature65 other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is EthSignature65 o && Equals(o);
        }
        ...
        /// Equals operator.
        /// </summary>
        public static bool operator ==(EthSignature65 x, EthSignature65 y)
        {
            return x.Equals(y);
        }
        ...
        internal static EthSignature65 Random()
        {
            var value = default(EthSignature65);
